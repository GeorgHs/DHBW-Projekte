...
<div id="nav">
   <div class="wrapper">
      <div class="name" >The social network<br><span></span></div> <a href="login.jsp"><button style="float: right;" ><b>Anmeldung und Registrierung !</b></button><br><br></a>
